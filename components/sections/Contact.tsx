            ...
            <div>
              ...
              <ol className="space-y-4">
                <li className="flex gap-4">
                  <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 flex items-center justify-center font-semibold text-sm flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="font-medium">ヒアリング</h4>
                    <p className="text-muted-foreground text-sm">
                      ビジネスのニーズと目標についてお伺いし、プロジェクトの要件を把握します。
                    </p>
                  </div>
                </li>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      ご要望に基づいて、スケジュールと料金を含む詳細な提案書を作成します。
                    </p>
                  </div>
                </li>
